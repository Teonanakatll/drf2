...
class WomenAPIListPagination(PageNumberPagination):
    page_size = 2
    # для регулировки количества записей на странице через адрессную строку браузера
    page_size_query_param = 'page_size'
    # ограничение на количество записей запращиваемых через адресную строку браузера ('page_size')
    max_page_size = 10000
